 ...
 * @property {boolean} listen If EmberDesk is listening on all network interfaces
 ...
 * @property {boolean} browserLaunchEnabled If automatically launch EmberDesk in the browser
