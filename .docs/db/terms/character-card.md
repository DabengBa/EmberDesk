...
`term.character_card` represents the user-facing unit EmberDesk shows in the character library and uses as a chat persona context. It describes the product concept, not the raw file format or parser implementation.
