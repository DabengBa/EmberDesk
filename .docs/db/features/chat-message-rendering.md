...
- Non-OpenAI, group, dry-run, nested-visible, quiet, and background generation paths remain legacy-owned and continue to use the ordinary `Generate()` / `StreamingProcessor` rendering path.
