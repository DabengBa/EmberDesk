...
- The overlay disappears when the main shell is usable for real interaction, even if secondary surfaces such as extensions are still warming.
...
- Background URL/render/settings compatibility is independent of startup panel loading and does not create a deferred Background Library stage.
