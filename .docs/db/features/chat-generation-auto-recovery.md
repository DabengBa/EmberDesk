...
- The React main-chat shell can show the current generation/recovery phase as a local shell status near the composer; this is placement/status ownership, not a new retry algorithm.
