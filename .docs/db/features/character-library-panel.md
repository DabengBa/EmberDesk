...
- The visible library contract stays the same during normal browsing and maintenance recovery; users should not have to rebuild or understand hidden cache/index state to browse current cards.
