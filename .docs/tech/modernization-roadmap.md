...
- 2026-06-05: Historical background panel controller boundary delivered. The former `public/scripts/background-panel-controller.js` loading-state slice and its background-library ownership record are superseded by the 2026-09-15 retirement; active chat background settings/metadata and static `backgrounds/*` compatibility remain separate retained contracts. Focused absence/retained-media proof is recorded in the current owning docs.
