...
| entry | verdict | current owner | rollback owner | evidence gate | blocking reason | durable doc owner | last reviewed |
|---|---|---|---|---|---|---|---|
| Character Authoring visible form surface inside the right drawer | `compatibility-facade` | guarded React character authoring surface | retained legacy drawer host and legacy write-through seams | `bun run --cwd tests test:e2e -- character-group-authoring.e2e.js --workers=1`; `bun run --cwd tests test:unit -- character-authoring-facade.test.js group-authoring-facade.test.js react-workspace-panels-helpers.test.js --runInBand` |  | `.docs/db/pages/chat-workspace.md`; `.docs/PROJECT_HISTORY.md` | 2026-07-07 |
| Group Authoring visible form surface inside the right drawer | `compatibility-facade` | guarded React group authoring surface | retained legacy drawer host and legacy write-through seams | `bun run --cwd tests test:e2e -- character-group-authoring.e2e.js --workers=1`; `bun run --cwd tests test:unit -- group-authoring-facade.test.js react-workspace-panels-helpers.test.js --runInBand` |  | `.docs/db/pages/chat-workspace.md`; `.docs/PROJECT_HISTORY.md` | 2026-07-07 |
