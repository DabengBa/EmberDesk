...
- `pnpm run build:react:workspace-panels` builds the shared workspace-panel bundle for World Info and Extensions Host; background URL/render/settings compatibility remains in the retained browser module without a Background Library panel or management action bridge.
