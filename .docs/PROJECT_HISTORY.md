...
| 2026-05-20 | ux | Unified delete dialog for character cards | Merge 3-layer serial popups (delete confirm → temp chat → world info cascade) into 1 dialog; add generation auto-stop to both bulk and single-character delete | [unified-delete-dialog design](specs/260520-01-unified-delete-dialog/design.md) |
