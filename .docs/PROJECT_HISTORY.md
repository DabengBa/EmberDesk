...
| 2026-05-21 | fix | Cascade delete UI cleanup for world info | Character-card cascade-delete of a world book left the WI editor panel showing stale ghost data; extract `flushDeletedWorldsFromUI()` to unify cleanup across both delete paths | — |
