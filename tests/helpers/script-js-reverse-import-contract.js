...
export const FIRST_PARTY_SCRIPT_JS_IMPORT_CONTRACT = Object.freeze([
    ...
    contractEntry('extensions/stable-diffusion/index.js', '../../../script.js', ['animation_duration', 'appendMediaToMessage', 'generateQuietPrompt', 'getCharacterAvatar', 'getCurrentChatId', 'getUserAvatar', 'saveSettingsDebounced', 'substituteParams', 'substituteParamsExtended', 'this_chid', 'user_avatar']),
    ...
    contractEntry('personas.js', '../script.js', ['buildAvatarList', 'characterToEntity', 'characters', 'chat', 'chat_metadata', 'createOrEditCharacter', 'default_user_avatar', 'getCurrentChatId', 'getThumbnailUrl', 'name1', 'name2', 'reloadCurrentChat', 'saveChatConditional', 'saveMetadata', 'saveSettingsDebounced', 'setUserName', 'this_chid']),
    contractEntry('power-user.js', '../script.js', ['ANIMATION_DURATION_DEFAULT', 'characters', 'chat', 'deleteMessage', 'doNewChat', 'entitiesFilter', 'extension_prompt_roles', 'extension_prompt_types', 'getCurrentChatId', 'getFirstDisplayedMessageId', 'messageFormatting', 'online_status', 'printCharactersDebounced', 'reloadCurrentChat', 'reloadMarkdownProcessor', 'saveChatConditional', 'saveSettings', 'saveSettingsDebounced', 'scrollChatToBottom', 'setActiveCharacter', 'setAnimationDuration', 'setCharacterId', 'setEditedMessageId', 'settingsReady', 'showMoreMessages', 'substituteParams']),
